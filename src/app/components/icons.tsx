...
/** Official Bizum isotype: 36° rounded bars + two dots. */
export function IconBizum({ className }: { className?: string }) {
    return (
        <svg viewBox="-1 -1 29 37" className={className} fill="currentColor" aria-hidden>
            <path d="M6.616 12.866c1.313.955 3.144.677 4.099-.637l3.422-4.736c.955-1.313.677-3.144-.637-4.1-1.313-.955-3.144-.677-4.099.637L5.939 8.766c-.915 1.313-.637 3.144.677 4.1ZM22.295 6.179c-1.313-.955-3.144-.677-4.099.637L4.427 25.761c-.955 1.314-.677 3.145.637 4.1 1.313.955 3.144.677 4.099-.637L22.932 10.278c.995-1.313.676-3.144-.637-4.1ZM5.302 4.666c.955-1.313.677-3.144-.637-4.1C3.352-.388 1.522-.11.567 1.204c-.955 1.313-.677 3.144.637 4.1 1.313.955 3.144.676 4.099-.637ZM26.195 30.697c-1.313-.955-3.144-.677-4.099.637-.955 1.313-.676 3.144.637 4.1 1.313.955 3.144.676 4.099-.637.955-1.314.676-3.145-.637-4.1Zm-5.372-7.523c-1.313-.955-3.144-.677-4.099.637l-3.462 4.736c-.955 1.314-.677 3.145.637 4.1 1.313.955 3.144.676 4.099-.637l3.462-4.736c.955-1.314.677-3.145-.637-4.1Z" />
        </svg>
    );
}
