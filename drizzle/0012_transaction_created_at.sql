-- SQLite rejects non-constant defaults on ADD COLUMN (strftime is not allowed).
ALTER TABLE `transaction` ADD `created_at` text NOT NULL DEFAULT '';--> statement-breakpoint
